...
RestaurantPizza.create!(price:30,pizza_id:4,restaurant_id:5)
RestaurantPizza.create!(price:5,pizza_id:2,restaurant_id:4)
RestaurantPizza.create!(price:10,pizza_id:2,restaurant_id:5)
RestaurantPizza.create!(price:15,pizza_id:1,restaurant_id:3)
RestaurantPizza.create!(price:25,pizza_id:4,restaurant_id:3)
RestaurantPizza.create!(price:30,pizza_id:1,restaurant_id:5)
